...
const EXACT_ZH_TO_EN: Record<string, string> = {
  ...
  "节点池": "Node Pool",
  "接入点": "Endpoints",
  "管理 Resin 对外监听的端口与可用能力。": "Manage Resin's listening ports and exposed capabilities.",
  "新建接入点": "New Endpoint",
  "编辑接入点": "Edit Endpoint",
  "默认接入点": "Default Endpoint",
  "自定义接入点": "Custom Endpoint",
  "默认接入点由环境变量定义，只读且不可删除":
    "The default endpoint is defined by environment variables and cannot be edited or deleted",
  "编辑接入点 {{port}}": "Edit endpoint {{port}}",
  "删除接入点 {{port}}": "Delete endpoint {{port}}",
  "确认删除接入点 {{port}}？": "Delete endpoint {{port}}?",
  "接入点 {{port}} 已保存": "Endpoint {{port}} saved",
  "接入点已删除": "Endpoint deleted",
  "正在加载接入点...": "Loading endpoints...",
  "已启用能力": "Enabled capabilities",
  "接入能力": "Endpoint Capabilities",
  "端口": "Port",
  "允许登录管理页面": "Allow Admin Console Access",
  "允许使用代理": "Allow Proxy Access",
  "管理页面": "Admin Console",
